<button?php require_once "../header.php" ; //if user is not admin if ($user->getRole() != 3) {
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card shadow-sm">
                            <div class="card-body text-center">
                                ...
                                <div class="d-grid gap-2">
                                    <a href="../distributions/distributionList.php" class="btn btn-outline-primary">View Distributions</a>
                                    <a href="../distributions/distributionAdd.php" class="btn btn-outline-primary">Add Distribution</a>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card shadow-sm">
                            <div class="card-body text-center">
                                ...
                                <div class="d-grid gap-2">
                                    <a href="../faculties/facultyList.php" class="btn btn-outline-primary">View Faculties</a>
