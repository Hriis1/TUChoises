                    ...
                    <div class="card shadow-sm">
                        <div class="card-body text-center">
                            ...
                            <div class="d-grid gap-2">
                                <button class="btn btn-outline-primary">View Users</button>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="card shadow-sm">
                        <div class="card-body text-center">
                            ...
                            <div class="d-grid gap-2">
                            <button class="btn btn-outline-primary">View Distributions</button>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="card shadow-sm">
                        <div class="card-body text-center">
                            ...
                            <div class="d-grid gap-2">
                            <button class="btn btn-outline-primary">View Majors</button>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="card shadow-sm">
                        <div class="card-body text-center">
                            ...
                            <div class="d-grid gap-2">
                            <button class="btn btn-outline-primary">View Faculties</button>
